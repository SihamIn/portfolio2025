(function ($) {
        ...
        if (canUseEmailJS) {
            ...
            emailjs.send(EMAILJS.serviceId, EMAILJS.templateId, templateParams)
                .then(function(response) {
                    ...
                    fallbackMailto(name, email, subject, message, $submitBtn, originalText);
                });
        } else {
            fallbackMailto(name, email, subject, message, $submitBtn, originalText);
        }
    ...
    function fallbackMailto(name, email, subject, message, $submitBtn, originalText) {
        ...
        if ($submitBtn) $submitBtn.prop('disabled', false).html(originalText || $submitBtn.html());
